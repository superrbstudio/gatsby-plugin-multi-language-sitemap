...
resolveSitemapAndIndex({
  ...
  sourceData: [
    ...
    {
      shorturl: '/amp/editor',
      url: 'https://www.aftership.com/test/amp/editor',
      changefreq: 'daily',
      priority: 0.7
    },
    {
      shorturl: '/amp/apps/mazet',
      url: 'https://www.aftership.com/test/amp/apps/mazet',
      changefreq: 'daily',
      priority: 0.7
    },
    {
    ...
    {
      shorturl: '/fr/features',
      url: 'https://www.aftership.com/test/fr/features',
      changefreq: 'daily',
      priority: 0.7
    },
    {
